/* CREATE TABLE PlotPoints AS SELECT ICAO, LATITUDE, LONGITUDE FROM PLANE_TRACKS;
...
ALTER TABLE PlotPoints ADD FOREIGN KEY (ICAO) REFERENCES Unique_PlotPoints(ICAO);
...
CREATE TABLE PLANE_TRACKS2 AS SELECT * FROM PLANE_TRACKS;

ALTER TABLE PLANE_TRACKS2 ADD PKEY NUMBER;


UPDATE PLANE_TRACKS2
